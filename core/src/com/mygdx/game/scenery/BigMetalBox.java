 ...
 * @author Deneyr
 */
public class BigMetalBox extends SmallBox{
    ...
    public BigMetalBox(World world, float posX, float posY) {
    ...
    public boolean applyDamage(int damage, Vector2 dirDamage, Object2D damageOwner){
        ...
        if(damageOwner instanceof CannonBallTriggeredObject2D){
            ...
            int animationUpdated = (this.getLifePointsMax() - this.getLifePoints()) / 2;
            ...
            if(this.canBeHitAgain){
                ...
                Timer.schedule(new Timer.Task(){
                    @Override
                    public void run() {
                        BigMetalBox.this.canBeHitAgain = true;
                    }
                }, 0.5f);
            }
        }
