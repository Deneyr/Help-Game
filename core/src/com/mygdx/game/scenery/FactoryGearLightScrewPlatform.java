 ...
 * @author Deneyr
 */
public class FactoryGearLightScrewPlatform extends FactoryGearScrewPlatform {
    
    public FactoryGearLightScrewPlatform(World world, float posX, float posY, float angle, float scale, float rotationSpeed, int testBlockIndex) {
