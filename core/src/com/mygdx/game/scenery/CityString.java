 ...
 * @author françois
 */
public class CityString extends SolidObject2D{
    private static final String CITYSTRINGTEXT = "urbanObj/Obstacle_Fils.png";
    
    private static final float SCALE_X = 0.5f;
    private static final float SCALE_Y = 0.5f;
    
    public CityString(World world, float posX, float posY){
        ...
        ground.setAsBox(300 * P2M * SCALE_X, 12 * P2M * SCALE_Y, new Vector2(-300 * P2M * SCALE_X, 0 * P2M * SCALE_Y), -0.05f);
